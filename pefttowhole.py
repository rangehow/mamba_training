...
# peft_model_id = "/data/ruanjh/mamba-translate-2.8b-lora/checkpoint-1700"
# model,tokenizer=load_model_and_tokenizer(model_dir,peft_model_id)
# model=model.merge_and_unload()
# print(type(model))
# model.base_model.save_pretrained('/data/ruanjh/mamba-translate-2.8b-ckpt1700lora',safe_serialization=False,max_shard_size='20GB')
