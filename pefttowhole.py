...
model_0,_=load_model_and_tokenizer('/data/ruanjh/mamba-2.8b-hf','/data/ruanjh/mamba-translate-2.8b-lora/checkpoint-6800')
...
model_1=MambaForCausalLM.from_pretrained('/data/ruanjh/mamba-translate-2.8b-ckpt6800lora')
